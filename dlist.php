   ...
   <td><table width="100%" border="0"></td>
    ...
    <table width="100%" border="1" bgcolor="#FFFFFF">
      <tr>
        ...
        <td bgcolor="#9966CC"><span class="style1">Specilist</span></td>
        ...
        <td bgcolor="#9966CC"><span class="style1">Remove</span></td>
      </tr>
      ...
      <tr bgcolor="#FFCCFF">
        ...
        <td><?php echo $row['9']?></td>
           <td><a href='remove_page.php?del_page=<?php echo $row['0']; ?>'>Remove</a></td>
      </tr>
	  <?php } ?>
    </table></td>
  </tr>
