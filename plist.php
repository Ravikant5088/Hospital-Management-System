   ...
   <td><table width="100%" border="0"></td>
    ...
    <table width="100%" border="1" bgcolor="#FFFFFF">
      <tr>
        ...
        <td bgcolor="#9966CC"><span class="style1">Problem</span></td>
        <td bgcolor="#9966CC"><span class="style1">Gender</span></td>
        <td bgcolor="#9966CC"><span class="style1">Doctor</span></td>
        <td bgcolor="#9966CC"><span class="style1">Room</span></td>
        <td bgcolor="#9966CC"><span class="style1">Date</span></td>
         ...
         <td bgcolor="#9966CC"><span class="style1">Print</span></td>
          <td bgcolor="#9966CC"><span class="style1">Edit</span></td>
      ...
      <tr bgcolor="#FFCCFF">
        ...
        <td><?php echo $row['8']?></td>
          ...
          <td><a href="pregistration.php?edit=<?php echo$row['0'];?>";>Edit</a></td>
